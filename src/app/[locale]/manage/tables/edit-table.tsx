...
export default function EditTable({
    ...
    const onSubmit = async (values: UpdateTableBodyType) => {
        ...
        try {
            const body: { number: number } & UpdateTableBodyType = { number: id as number, ...values };
                        ...
                        <div className="grid gap-4 py-4">
                                        ...
                                        <div className="grid grid-cols-4 items-center justify-items-start gap-4">
                                            ...
                                            <div className="col-span-3 w-full space-y-2">
                                                <Select
                                                    ...
                                                    defaultValue={field.value} // Dòng này là định nghĩa giá trị ban đầu
                                                    value={field.value} // Thêm dòng này để sau khi fetch dữ liệu, nó cập nhật được giá trị mới
                                                >
                                                    <FormControl>
                                                        <SelectTrigger>
                            ...
                            <FormItem>
                                <div className="grid grid-cols-4 items-center justify-items-start gap-4">
                                    <Label>QR Code</Label>
                                    <div className="col-span-3 w-full space-y-2">
                                        {table && <QrCodeTable token={table.token} tableNumber={table.number} />}
                                    </div>
                                </div>
                            </FormItem>
                            <FormItem>
